...
## ⛹️  Lab - Using multi-stage Dockerfile to build and deploy your application from source code from GitHub repo
```
...
## ⛹️  Lab - Build the application using BuildConfig and create an ImageStream 
...
## ⛹️  Lab - Deleting an image from OpenShift container registry
```
...
## ⛹️   Lab - Deploying application as a template
